...
class TextDataset(Dataset):
    def __init__(self, tokenizer, args,data_limit, file_path=None):
        self.examples = []
...
def evaluate(args, model, tokenizer,eval_when_training=False):
    ...
    if eval_dataset is None:
        eval_dataset = TextDataset(tokenizer, args,1000,args.eval_data_file)
...
def test(args, model, tokenizer):
    # Loop to handle MNLI double evaluation (matched, mis-matched)
    eval_dataset = TextDataset(tokenizer, args,1000,args.test_data_file)
...
def main():
    ...
    parser.add_argument('--data_limit', type=int, default=700, help="Data limit for data list")
    ...
    if args.do_train:
        ...
        train_dataset = TextDataset(tokenizer, args,args.data_limit,args.train_data_file)
